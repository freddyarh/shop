            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  />
                   { errors.title && (
                      <p className="text-red-500 text-sm">The title is required</p>
                    )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                     { errors.price && (
                      <p className="text-red-500 text-sm">Precio should be more than 0</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    { errors.stock && (
                      <p className="text-red-500 text-sm">Stock should be more than 0</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    { ...register('slug', {
                      required: true,
                      validate: (value) => !/\s/.test(value) || 'The slug can not have spaces'
                      })}
                      className={cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                        {
                ...
                <div>
                  ...
                  />
                  { errors.description && (
                    <p className="text-red-500 text-sm">The description is required</p>
                  )}
                </div>
              </div>
            </div>
